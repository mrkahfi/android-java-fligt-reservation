...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    public void setCustomTabView(int layoutResId, int textViewId, int textViewId2) {
        mTabViewLayoutId = layoutResId;
        mTabViewTextViewId = textViewId;
        mTabViewTextViewId2 = textViewId2;
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                if (mTabViewTextViewId2 != 0) {
                    tabTitleView2 = (TextView) tabView.findViewById(mTabViewTextViewId2);
                    tabTitleView2.setTextColor(getResources().getColor(R.color.colorPrimaryRed));
                }
            }
            ...
            if (tabTitleView2 != null) {
                tabTitleView2.setText(adapter.getPageSubTitle(i));
            }
