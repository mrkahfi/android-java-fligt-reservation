...
public class CustomRangeBar extends RangeBar {
    ...
    private PinTextFormatter mPinTextFormatter = new PinTextFormatter() {
        ...
        public String getText(String value) {
            return Utils.getMoneyFormat(Integer.parseInt(value.length() >= 4 ? value.substring(0, value.length() - 3) : value), false);
        }
    };
    ...
    public void setTicks(float tickStart, float tickEnd, float interval) {
