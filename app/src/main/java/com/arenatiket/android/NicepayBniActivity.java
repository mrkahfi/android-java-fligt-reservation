...
public class NicepayBniActivity extends AppCompatActivity {
    ...
    private TextView reservationId2TextView;
    private boolean expired = true;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nicepay_bni);
        ...
        reservationId2TextView = (TextView) findViewById(R.id.reservationId2TextView);
        ...
        try {
            ...
            reservationId2TextView.setText(reservationId);
    ...
    private void promptGoToHome() {
        ...
        builder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent = new Intent(NicepayBniActivity.this, SearchActivity.class);
